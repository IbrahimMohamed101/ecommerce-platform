...
log "  -Dquarkus.liquibase.clear-checksums=true"
log "  -Dquarkus.liquibase.validate-on-migrate=false"
log "  -Dquarkus.liquibase.migrate-at-start=true"
...
# JVM options with system properties for Liquibase override
